...
- "audit everything" → all platforms (web, ios, android, convex)
...
1. **Enumerate scope**: list platforms (`apps/web`, `apps/ios`, `apps/android`, `services/convex`) and the spec IDs in scope.
